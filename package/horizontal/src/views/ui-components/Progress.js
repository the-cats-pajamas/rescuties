...
const ProgressComponent = () => {
    return (<
      ...
      div >
                                                                                                                                                        ...
                                                                                                                                                        /> <
                                                                                                                                                            Progress className="mb-3"
                                                                                                                                                            striped color="warning"
                                                                                                                                                            value={
                                                                                                                                                                75
                                                                                                                                                            }
                                                                                                                                                        /> <
                                                                                                                                                            Progress className="mb-3"
                                                                                                                                                            striped color="danger"
                                                                                                                                                            value="100" />
                                                                                                                                                        <
      Progress className="mb-3"
                                                                                                                                                            multi >
                                                                                                                                                            ...
                                                                                                                                                            <
                                                                                                                                                                Progress striped bar color="success"
                                                                                                                                                                value="30" />
                                                                                                                                                            <
                                                                                                                                                                Progress striped bar color="warning"
                                                                                                                                                                value="20" />
                                                                                                                                                            <
                                                                                                                                                                Progress striped bar color="danger"
                                                                                                                                                                value="20" />
                                                                                                                                                            <
      /Progress> <
      /div> <
      ...
      Progress className="mb-3"
                                                                                                                                                                                    ...
                                                                                                                                                                                    <
                                                                                                                                                                                        ...
                                                                                                                                                                                        value="30" />
                                                                                                                                                                                    <
                                                                                                                                                                                        Progress animated bar color="warning"
                                                                                                                                                                                        value="20" />
                                                                                                                                                                                    <
                                                                                                                                                                                        Progress animated bar color="danger"
                                                                                                                                                                                        value="20" />
                                                                                                                                                                                    <
      /Progress> <
      /div> <
